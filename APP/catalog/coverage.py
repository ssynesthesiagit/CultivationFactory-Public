...
STAGE1_CATEGORY_SPECS: tuple[CategorySpec, ...] = (
    ...
    CategorySpec("origin_insight_choice", "Origin Insight", ("cultivation_insight", "origin_insight", "insight")),
    ...
    CategorySpec("insight_priorities", "Additional Insight Priorities", ("cultivation_insight", "origin_insight", "insight")),
